...
INFLUXDB_URL = os.getenv("INFLUXDB_URL", config.INFLUXDB_URL)
INFLUXDB3_AUTH_TOKEN = os.getenv("INFLUXDB3_AUTH_TOKEN", config.INFLUXDB3_AUTH_TOKEN)
INFLUXDB_DATABASE = os.getenv("INFLUXDB_DATABASE", config.INFLUXDB_DATABASE)
...
def generate_dummy_data(days=7):
    ...
    # Create InfluxDB service with same config format as your main.py
    INFLUXDB_PARAMS = {
        "url": INFLUXDB_URL,
